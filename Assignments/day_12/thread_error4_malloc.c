/*
 * A simple program having multiple threads
 ...
 * This inturn creates 2 other threads to display lsb and msb  of  passed input
 * This program does not have memory leak but does not produce the expected output
 */
